...
finetune.py 명령어 python -m torch.distributed.launch finetune.py --data_path "fine-tune_data_path" --model_path "pretrained_model_path" --batch_size 1 --grad_acc 180
